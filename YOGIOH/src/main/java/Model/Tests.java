...
public class Tests {
    ...
    @Test
    public void test1User() throws DuplicateNicknameException, DuplicateUsernameException {
    ...
    @Test
    public void test2User() throws DuplicateNicknameException, DuplicateUsernameException {
